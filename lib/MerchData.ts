export const Products = [
    {
        ...
        description: `The SDFM Premium Hoodie combines urban style with ultimate comfort. Made with premium cotton blend fabric,
                       ...
                       `,
        images: ["/merch/2.jpg","https://i.pinimg.com/736x/94/d3/14/94d31436dfc73fcf93058089f69ffd96.jpg"],
    ...
    },
    {
        ...
        images: ["/merch/3.jpg", "https://i.pinimg.com/736x/94/d3/14/94d31436dfc73fcf93058089f69ffd96.jpg"],
        sizeAvailable: ['S', 'M', 'L'],
    },
    {
        id: 4,
        ...
        price: 169.99,
        discountedPrice: 149.99,
        description: `The SDFM Retro Logo Hoodie pays homage to classic streetwear style. Made with soft cotton blend fabric, it features a vintage-inspired logo print, adjustable drawstring hood, and front kangaroo pocket. A timeless addition to any wardrobe.`,
        images: ["/merch/4.jpg","https://i.pinimg.com/736x/94/d3/14/94d31436dfc73fcf93058089f69ffd96.jpg"],
        sizeAvailable: ['S', 'M', 'L'],
    }
];
