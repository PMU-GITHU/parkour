...
const athletes = [
    ...
    { ID: 19, hasStunts: true, Name: 'Mohamed Mouraoui', Age: '28 y.o', Description: "I started parkour at an early age. after years of practice I became a coach of parkour and gymnastic with clubs at the regional level. then I started to make my movement on the action movies where I became a stunt man on the movies as a creator action fighting. our community creating suitable environment for practicing parkour and exchanging information and skills among all the players of this group, especially the new generation.", Picture: "/athletes/DSC08756.JPG", MoveTrick: null },
    ...
    { ID: 28, hasStunts: true, Name: 'Azize Boumane', Age: '34 y.o', Description: null, Picture: "/athletes/DSC08753.JPG", MoveTrick: null },
    { ID: 8, hasStunts: true, Name: 'Wassim Boulouk', Age: '30 y.o', Description: null, Picture: "/athletes/DSC06869.JPG", MoveTrick: null }
];
